<template>
  <div>
    <h1 class="text-center my-4">Form 433f</h1>
  ...
  methods: {
    ...
    async editAndDisplayPdf() {
      const response = await fetch(
        "https://api.premiertaxdebtsolutions.com/uploads/assistance/1730787237390.pdf"
      );
      ...
      const formData = {
        ...
        "topmostSubform[0].Page1[0].ssn[0].YourSocialSecurityNu[0]":
          this?.userData?.ssn || "",

        "topmostSubform[0].Page1[0].address[0].CountyResidence[0]": "USA",
        ...
        "topmostSubform[0].Page1[0].your_telephone[0].Cell11[0]": this?.userData
          ?.contactInfo?.mobile
        ...
        //   : "",
        "topmostSubform[0].Page1[0].your_telephone[0].Home11[0]": this?.userData
          ?.contactInfo?.home
        ...
        //   : "",
        "topmostSubform[0].Page1[0].your_telephone[0].Work11[0]": this?.userData
          ?.contactInfo?.work
        ...
        "topmostSubform[0].Page1[0].age[0].NameBusiness[0]": this?.userData
          ?.employmentInfo?.businessName
          ? this?.userData?.employmentInfo?.businessName
          : "",
        "topmostSubform[0].Page1[0].age[0].BusinessEIN[0]": this?.userData
          ?.generalInfo?.einNumber
        ...
        "topmostSubform[0].Page1[0].age[0].TypeBusiness[0]": businessType
          ? businessType
          : "",
    ...
    async pay() {
      ...
      if (
        ...
        payload.from = `admin-433f&requestNumber=${this.$route.query.requestNumber}&userId=${this.$route.query.userId}`;
      } else if (
        this.$auth.user?.role_id === 2 &&
        this.$route.path.includes("user")
      ) {
        payload.from = `user-433f&requestNumber=${this.$route.query.requestNumber}&userId=${this.$route.query.userId}`;
      }
      try {
      ...
      try {
        ...
        if (res.data && Array.isArray(res.data)) {
          res.data.forEach((payment) => {
            if (
              payment.payment_service === "Form 433f" &&
